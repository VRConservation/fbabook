...
2. Draft a back-of-the-envelope budget by project category or deliverable, roughing out the approximate costs **(use Chris's budget calculator** with rules that divide out salaries implementation)
3. Write a proposal narrative
4. Create a project GANTT chart with deliverables from the budget and narrative

```{tip}  
When you create a GANTT chart in Excel, make the deliverable names equal in the chart to your budget deliverable headings in the budget spreadsheet. When you change the budget deliverables, the GANTT deliverables will also change.
```
